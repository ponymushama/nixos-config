...

{
  ...
  networking.hostName = "ponymushama"; # Define your hostname.
  ...
  environment.systemPackages = with pkgs; [
    ...
    dconf
    nix-ld
    gnomeExtensions.kimpanel # fcitx5 wayland panel
  ];
  ...
  security.wrappers.mihomo-party = {
    source = "${pkgs.mihomo-party}/bin/mihomo-party";  # 修改为 mihomo-party
